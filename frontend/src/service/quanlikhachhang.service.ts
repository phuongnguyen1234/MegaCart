 ...
 * Tương ứng với endpoint `GET /api/quan-ly/khach-hang`.
...
export const getDanhSachKhachHang = (
  ...
  return apiClient.get("/quan-ly/khach-hang", { params });
};

/**
 * Lấy thông tin chi tiết của một khách hàng.
 * Tương ứng với endpoint `GET /api/quan-ly/khach-hang/{maKhachHang}`.
...
export const getChiTietKhachHang = (
  ...
  return apiClient.get(`/quan-ly/khach-hang/${maKhachHang}`);
};

/**
 * Cập nhật trạng thái tài khoản của một khách hàng (ví dụ: khóa hoặc mở khóa).
 * Tương ứng với endpoint `PATCH /api/quan-ly/khach-hang/{maKhachHang}/cap-nhat-trang-thai`.
...
export const capNhatTrangThaiKhachHang = (
  ...
  return apiClient.patch(
    `/quan-ly/khach-hang/${maKhachHang}/cap-nhat-trang-thai`,
    data
  );
};
