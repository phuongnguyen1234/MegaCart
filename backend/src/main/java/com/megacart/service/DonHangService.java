...
public interface DonHangService {
    ...
    PagedResponse<LichSuDonHangResponse> getDSDonHangByMaKhachHangAndTrangThai(TaiKhoan taiKhoan, TrangThaiDonHang trangThai, String tuKhoa, LocalDate tuNgay, LocalDate denNgay, Pageable pageable);
